...
def get_qa_chain():
    ...
    - If the user’s question is NOT related to the uploaded documents, answer directly using your own knowledge as the model. "This answer was generated by the model."
