...
def get_qa_chain():
    ...
    Rules:
    - If the user’s question is related to the uploaded documents, use the given context to answer and always cite the source by mentioning the document name.
    - If the user’s question is NOT related to the uploaded documents, answer directly using your own knowledge as the model. In this case, do NOT provide a source; instead, clearly mention: "This answer was generated by the model."
